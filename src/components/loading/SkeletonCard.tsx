export function SkeletonCard() {
  return (
    <div className="flex flex-col w-full max-w-2xl gap-8 p-8 border border-text border-opacity-20 bg-background rounded-lg animate-pulse">
      ...
      <div
        className="h-12 w-full flex animate-pulse bg-green-500/50
rounded-lg "
      ></div>
    </div>
  );
